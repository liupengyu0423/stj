  ...
  <div class="net">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="row1 col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4>互联网+ 智能厕所
          </h4>
    ...
    <div class="container-fluid">
      <div class="row">
        <img src="../../images/net2.png"
             alt=""
             class="img-responsive">
        <div class="row2 col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4>IoT 终端设备
          </h4>
          <p>每一台生态洁厕所，都是一台智能设备。</p>
    ...
    <div class="container-fluid">
      <div class="row">
        <img src="../../images/net3.png"
             alt=""
             class="img-responsive">
        <div class="row3 col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4>运维 APP
          </h4>
          <p>每一台生态洁厕所，都是高效运维的典范。</p>
    ...
    <div class="container-fluid">
      <div class="row">
        <img src="../../images/net4.png"
             alt=""
             class="img-responsive">
        <div class="row4 col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4>智能家居 APP
          </h4>
          <p>每一台生态洁厕所，都是用户的智能家居。</p>
